...
export const metadata: Metadata = {
  title: "Liro - Digital Agency & Creative Portfolio NextJs Template",
  description: "Generated by create next app",
  icons: {
    icon: [
      { url: "/assets/img/logo/logo.png", sizes: "192x192", type: "image/png" },
    ],
  },
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="no-js Liro-light" suppressHydrationWarning={true}>
