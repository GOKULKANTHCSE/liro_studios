import LiroImg from "../../../../public/assets/img/home-05/footer/Liro.png"
    ...
    return (
        <div className="design-copyright-area pt-45">
                ...
                <div className="row">
                    <div className="col-md-6">
                        <div className="design-copyright-text text-center text-md-start mb-10">
                            <p>© {getCurrentYear()} Liro, All rights reserved.</p>
                        </div>
                    </div>
                    <div className="col-md-6">
            ...
            <div className="design-copyright-big-text pt-120">
                <Image style={{ width: "100%", height: "auto" }} src={LiroImg} alt="Liro-image" />
            </div>
        </div>
    );
};
