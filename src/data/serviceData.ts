...
import service1 from "../../public/assets/img/home-01/service/service-1.jpeg";
...
const servicesData: servicesDT[] = [
...

    {
        ...
        image: service1,
        description: "Create a lasting impression with a cohesive brand identity. From logo design to color palettes and typography, we craft visually compelling brand elements that reflect your values and resonate with your target audience.",
        categories: ["Logo Design", "Color Strategy", "Typography", "Brand Guidelines", ],
        link: "/",
    },
    {
        id: 2,
        ...
        image: service3,
        description: "Bring your story to life with professionally produced content. From concept to final delivery, we create engaging blogs, videos, infographics, and multimedia assets that captivate your audience and drive meaningful engagement.",
        categories: ["Video Production", "Photography", "Copywriting", "Graphic Design"],
        link: "/",
    },
    {
        id: 3,
        title: "AI Portrait Creation",
        image: service4,
        description: "Transform your photos into stunning artistic portraits using cutting-edge AI technology. We generate personalized, high-quality portraits that capture your essence in unique styles, from realistic to artistic interpretations.",
        categories: ["Style Customization", "Photo Enhancement", "Digital Delivery", "Batch Processing"],
        link: "/",
    },
     {
        id: 4,
        title: "Web Design",
        image: service4,
        description: "Create a digital presence that converts. Our expert designers build responsive, user-friendly websites that showcase your brand, engage visitors, and drive measurable results across all devices.",
        link: "/",
    },
        {
        id: 5,
        ...
        image: service2,
        description: "Build a powerful social presence that drives real results. From content creation to community engagement, our team manages your accounts across Instagram, Facebook, LinkedIn, and TikTok to grow your audience and strengthen brand loyalty.",
        categories: ["Content Creation", "Community Management", "Social Advertising", "Analytics & Reporting"],
        link: "/",
    },
