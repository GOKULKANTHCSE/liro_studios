    ...
    return (
        <>
            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="14" viewBox="0 0 17 14" fill="none">
                <path d="M2.58672 1H14.593C15.4184 1 16.0938 1.675 16.0938 2.5V11.5C16.0938 12.325 15.4184 13 14.593 13H2.58672C1.76129 13 1.08594 12.325 1.08594 11.5V2.5C1.08594 1.675 1.76129 1 2.58672 1Z" stroke="#6ec164" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M16.0938 2.5L8.58984 7.75L1.08594 2.5" stroke="#6ec164" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
        </>
    );
};
